...
var app = angular.module('liveguardManager', ['ngResource', 'satellizer', 'angular-jwt', 'ui.router', 'angularMoment', 'ngFileUpload']).constant('API', '/manager/api')
//.config(InterceptorConfig)
.constant('FACEBOOK_API_KEY', '1204326232924507').controller('consoleController', _ConsoleController2.default).directive('fileModel', ['$parse', function ($parse) {
  return {
    restrict: 'A',
